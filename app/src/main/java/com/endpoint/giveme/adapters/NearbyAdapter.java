...
public class NearbyAdapter extends RecyclerView.Adapter<NearbyAdapter.MyHolder> {
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        ...
        public void BindData(PlaceModel placeModel) {
            ...
            {
                String url = "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference="+placeModel.getPhotosList().get(0).getPhoto_reference()+"&key=AIzaSyBXYdxWjXHPrZ1Qv5jBujwc2frR1_QRabg";
